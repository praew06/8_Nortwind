...
INSERT INTO `employees` (`employeeid`, `lastname`, `firstname`, `title`, `birthdate`, `hiredate`, `address`, `city`, `region`, `postalcode`, `country`, `homephone`, `extension`, `reportsto`) VALUES
...
INSERT INTO `orders` (`orderid`, `customerid`, `employeeid`, `orderdate`, `requireddate`, `shippeddate`, `shipvia`, `freight`, `shipname`, `shipaddress`) VALUES
(2, '2', '3', '1', '4', 'qwres', 'dfgfdg', 'vcbcv', 'vcb', 'bn');
...
(1, '23', '24224', '13', 14, '234', '11', '11', '778', 'gfj', 'vb');
...
--
ALTER TABLE `categories`
  MODIFY `categoryid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
